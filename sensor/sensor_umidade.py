...
MEU_ID = "ST02"             #Identificador dele lá na lista
MEU_TIPO = "umidade"    #tipo do dispositivo padroinzado
MEU_PORTA = 5010            #porta unicast do dispositivo (diferente)
...
def enviar_leituras():
    ...
    while True:
        ...
        # dados da leitura
        leitura.id = MEU_ID
        leitura.valor = 50.0 + (random.random() * 40.0)      # valor fake por enquanto
